...
export const myName = 'Surendra' 

// export {usersData}   // it is named export because we are exporting multiple things from this file, so we have to use named export.
// export {usersData, myName as myNames}
// we can change the name of the export while importing it in another file. For example, we can import myNames as myName in another file.
